...
<div className="bg-white rounded-xl p-6 border-2 border-[#C5E8E4] shadow-sm">
  ...
  <div className="space-y-4">
    ...
    <button className="w-full px-6 py-3 bg-[#275559] text-white rounded-lg 
...
```jsx
<button className="px-6 py-3 bg-teal-dark text-white rounded-lg 
...
```jsx
<button className="px-6 py-3 bg-teal-medium text-white rounded-lg 
...
```jsx
<button className="px-6 py-3 bg-white text-teal-medium border-2 border-teal-light 
...
**Primary Button:**
```jsx
<button className="px-6 py-3 bg-[#275559] text-white rounded-lg 
                   font-semibold hover:bg-[#1f4447] transition-colors
                   min-h-[44px]">
  Primary Action
</button>
...
```jsx
<div className="bg-white rounded-xl p-4 sm:p-6 border-2 border-[#C5E8E4] 
...
<div className="flex justify-start mb-4">
  <div className="max-w-[75%] sm:max-w-[60%]">
    <div className="bg-white border-2 border-[#C5E8E4] rounded-2xl rounded-tl-sm 
                    px-4 py-3 shadow-sm">
...
<div className="border-t-2 border-[#C5E8E4] bg-white p-4 safe-area-inset-bottom">
  <div className="flex items-end gap-3">
    <textarea
      ...
      rows={1}
    />
    <button className="px-6 py-3 bg-[#275559] text-white rounded-xl
                       font-semibold hover:bg-[#1f4447] transition-colors
...
<div className="flex flex-col h-screen">
  ...
  {/* Input */}
  <div className="border-t-2 border-[#C5E8E4] bg-white p-4 flex-shrink-0">
    {/* Input area */}
  </div>
</div>
```
