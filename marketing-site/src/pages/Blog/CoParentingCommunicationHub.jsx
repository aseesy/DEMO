      ...
      <div className="bg-gradient-to-b from-teal-50 to-white pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
            Practical guides, scripts, and strategies to help you communicate effectively with your
            co-parent, even in high-stress situations.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map(article => (
            ...
            >
              {/* Article Image */}
              <div
                className={`bg-teal-50 ${article.featured ? 'md:w-1/2 min-h-[300px]' : 'h-48'} flex items-center justify-center overflow-hidden`}
              >
                {article.image ? (
                  <img
                    src={article.image}
              ...
              >
                ...
                <h3
                  className={`font-bold text-teal-dark mb-3 group-hover:text-teal-medium transition-colors ${article.featured ? 'text-2xl sm:text-3xl' : 'text-xl'}`}
                >
                  {article.title}
                </h3>
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="flex gap-6 mb-6">
            ...
            <a href="/liaizen-ai" className="text-gray-500 hover:text-teal-medium">
              LiaiZen AI
            </a>
