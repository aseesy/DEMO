...
**Purpose**: Measure user satisfaction, identify improvement areas, and track NPS over time.

**Last Updated**: 2025-11-26
**Frequency**: Monthly or after key milestones
**Target Responses**: Minimum 30 for statistical relevance

---

## Survey Introduction

> Thank you for using LiaiZen! Your feedback helps us improve the experience for all co-parents.
>
> This survey takes about 5 minutes. Your responses are confidential and will only be used to improve our product.
...
- [ ] Better organized communication
- [ ] AI helps me communicate more effectively
...
- [ ] AI message suggestions/rewrites
...
- [ ] Well - it captures my point with minor differences
- [ ] Okay - I often need to modify the suggestion
- [ ] Poorly - it misses my point or changes my meaning
- [ ] Very Poorly - I rarely find the suggestions helpful
...
- [ ] Very reliable - rare minor issues
- [ ] Moderately reliable - occasional issues
- [ ] Somewhat unreliable - frequent issues
...
- [ ] $10-20/month
- [ ] $20-30/month
- [ ] $30+/month - if the features are valuable enough
...
> Thank you for completing this survey! Your feedback is invaluable in helping us build a better experience for co-parents everywhere.
>
> If you'd like to participate in future research (interviews, usability tests), please enter your email below. Otherwise, leave blank.
>
...
- Feature adoption (AI users vs non-users)
