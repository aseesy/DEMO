...
This directory contains reusable templates for user research activities.
...
3. Create prototypes
4. Validate with **Usability Tests**
...
3. Iterate on design
4. Validate with **Usability Tests**
5. Monitor impact in next **Survey**
...
2. **Voluntary Participation**: Participants can stop at any time without consequence
3. **Confidentiality**: Never share identifying information
4. **Emotional Safety**: Be prepared for emotional responses; have support resources ready
5. **No Judgment**: Create safe space for honest sharing
...
- Never share individual data externally
...
2. Update relevant artifacts:
   ...
   - Jobs-to-be-Done (`.docs/product/jtbd/`)
   - Communication Patterns (`.docs/product/ai-mediation/`)
