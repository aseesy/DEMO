# Communication Patterns Guide for AI Mediation

**Purpose**: Reference guide for understanding hostile vs. healthy co-parenting communication patterns. Used by AI mediation system and product team to ensure message rewriting preserves intent while reducing conflict.
...
4. Focus on **preserving intent** while improving delivery
...
**Examples**:
| Hostile | Why It Escalates |
|---------|------------------|
| "You're ALWAYS late" | Dismisses any time they were on time, feels like attack |
| "You NEVER help" | Ignores all contributions, feels unfair |
| "You always do this" | Vague accusation that can't be addressed |
...
| Hostile | Rewritten |
|---------|-----------|
| "You're ALWAYS late" | "I need you to be on time for Friday's pickup at 5pm" |
| "You NEVER help with homework" | "Can you help Emma with her math homework on your nights?" |
| "You always forget" | "Please remember to send his medication this weekend" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "This is YOUR fault" | Triggers defensive response |
| "You caused this" | Past-focused, not solution-focused |
| "Because of you, now..." | Assigns blame, ignites conflict |
...
| Hostile | Rewritten |
|---------|-----------|
| "This is your fault she's upset" | "Emma seems upset. Can we talk about how to help her?" |
| "Because of you, we missed the deadline" | "The deadline passed. How can we handle this now?" |
| "You caused this whole mess" | "Let's focus on what we can do from here" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "She told me you didn't feed her dinner" | Uses child as reporter, implies neglect |
| "The kids say they don't like it there" | Weaponizes children's statements |
| "He came home crying because of you" | Blames parent via child's emotions |
...
| Hostile | Rewritten |
|---------|-----------|
| "She told me you didn't make her lunch" | "Can we coordinate on lunch plans for school days?" |
| "The kids say they're bored at your place" | "What activities do you have planned for the weekend?" |
| "He said you yelled at him" | "Jake seemed upset when he came home. Is everything okay?" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "Just like when you..." | Drags up irrelevant history |
| "This is the same thing you did in 2019" | Prevents present-focus |
| "You've always been..." | Character attack based on history |
...
| Hostile | Rewritten |
|---------|-----------|
| "Just like when you forgot her birthday" | "Please confirm you have her birthday party at 2pm Saturday" |
| "You've always been unreliable" | "Can you confirm the pickup time?" |
| "This is the same thing you did last year" | "I need clarity on this year's holiday schedule" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "WHY can't you just..." | Caps feel like shouting |
| "Fine. Whatever." | Passive-aggressive dismissal |
| "Oh, so NOW you care?" | Sarcasm implies bad faith |
| "Thanks SO much for nothing" | Sarcasm + accusation |
...
| Hostile | Rewritten |
|---------|-----------|
| "WHY can't you just be on time???" | "I need you to be on time. Can you confirm 5pm?" |
| "Fine. Whatever." | "I disagree, but I'll move forward with your suggestion" |
| "Oh, so NOW you care?" | "I'm glad you're engaged with this" |
| "Thanks SO much for nothing" | "I was hoping for more support on this" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "If you don't... I'll..." | Escalates to confrontation |
| "My lawyer will hear about this" | Escalates to legal threat |
| "You'll be sorry" | Vague threat |
...
| Hostile | Rewritten |
|---------|-----------|
| "If you're late again, I'm calling my lawyer" | "Consistent pickup times are important. Can we agree on 5pm?" |
| "You'll regret this" | "This decision concerns me. Can we discuss?" |
| "I'm documenting everything" | "I'd like to have a record of our agreement" |
...
| Hostile | Why It Escalates |
|---------|------------------|
| "You're doing this on purpose" | Assumes malicious intent |
| "You just want to hurt me" | Projects motivation |
| "You don't care about the kids" | Attacks character based on assumption |
...
| Hostile | Rewritten |
|---------|-----------|
| "You're doing this on purpose" | "I'm confused by this decision. Can you explain your thinking?" |
| "You don't care about the kids" | "I'm concerned about this situation. Can we discuss what's best for them?" |
| "You just want to control everything" | "I'd like more input on these decisions" |
...
|---------|--------------|
| "Friday's pickup is at 5pm. Can you confirm?" | Specific, actionable, non-accusatory |
| "Emma has a doctor's appointment Thursday at 3pm" | Informational, no implied criticism |
| "I need the permission slip signed by Wednesday" | Clear deadline, clear request |
...
| Healthy | Why It Works |
|---------|--------------|
| "Jake needs help with his science project this week" | About child's need, not parent's failure |
| "She seems anxious about the transition. Ideas?" | Collaborative problem-solving |
| "What activities does he enjoy at your place?" | Genuine curiosity, not interrogation |
...
| Healthy | Why It Works |
|---------|--------------|
| "I feel concerned when plans change last-minute" | Owns the feeling, doesn't accuse |
| "I need more notice for schedule changes" | States need, not blame |
| "I'm confused about the arrangement" | Admits uncertainty, invites clarification |
...
| Healthy | Why It Works |
|---------|--------------|
| "Can we discuss the holiday schedule?" | Opens dialogue |
| "What works best for you?" | Shows flexibility |
| "How should we handle this?" | Frames as shared problem |
| "I'd like to find a solution that works for both of us" | Explicitly collaborative |
...
| Healthy | Why It Works |
|---------|--------------|
| "I understand your concern. My perspective is..." | Shows listening before disagreeing |
| "That's a good point. I also think..." | Acknowledges validity |
| "I see why you'd want that. What if we tried..." | Validates, then proposes alternative |
...
- [ ] The sender's **voice** is recognizable (don't make Mike sound like Sarah)
...
- Message uses hostile tone markers (caps, excessive punctuation)
...
5. **Authentic** (sounds like the sender, not a lawyer)
