# User Persona: Erika - Recovering Mother Rebuilding Life

**Persona Type**: Primary (Paired with Ben)
...
Erika wanted to maintain a smaller family due to personal limits, but felt pressured into having a second child out of relational duty. She developed severe postpartum depression after Luca's birth, which eventually led to alcohol dependency.

She completed an 8-month rehab program in 2023 and is now rebuilding her life with a deep desire for **dignity, stability, and respect**. The divorce was finalized after her recovery.
...
- Relies heavily on **AI to check her tone**
...
- Responds well to **"You have the right to ask for this"** framing
...
4. **Communication coaching that promotes internal dignity**
...
- **Receiving help**: Interpret incoming messages charitably
...
## Jobs-to-be-Done (Erika-Specific)

1. **When** I need to communicate with Ben, **I want to** express myself clearly **so that** I don't come across as weak or uncertain.

2. **When** I receive a message that feels like judgment, **I want to** understand his actual intent **so that** I don't spiral into defensiveness.

3. **When** I need to set a boundary, **I want to** do it with confidence **so that** I'm respected without having to fight.

4. **When** I make parenting decisions, **I want to** communicate them as fact **so that** I'm seen as a capable parent.

5. **When** I feel criticized, **I want to** respond from strength **so that** I don't reinforce old patterns.
...
- Acknowledge her strength in seeking better communication
...
> "I just want to be seen as a good mom. I'm not asking for praise - just not to be constantly reminded of my worst year."

> "When he says 'as usual,' I hear everything he's ever thought about me."

> "I know I'm probably reading too much into it, but..."

> "I'm trying so hard. I just wish he could see that."
...
- Recognize her strength in seeking better communication
