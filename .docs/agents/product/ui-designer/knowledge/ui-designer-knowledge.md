...
Accumulated knowledge and learnings for design decisions.
...
- **Token file**: `frontend/design-system/tokens/tokens.json`
- **Build output**: `frontend/design-system/build/`
- **UI Test Lab**: `frontend/src/pages/UITestLab.tsx`
