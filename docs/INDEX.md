...
## 📋 Specifications
- [Feature Specs](../specs/) - All feature specifications
- [Server Specs](../chat-server/specs/) - Backend specifications

## 📦 Archived Documentation
Historical completion reports, summaries, and analysis documents are archived in [docs-archive/](../docs-archive/).

## 📖 Documentation Standards
See [DOCUMENTATION_STANDARDS.md](DOCUMENTATION_STANDARDS.md) for guidelines on creating and maintaining documentation.
