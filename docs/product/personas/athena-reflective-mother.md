# User Persona: Athena - Reflective Mother

**Persona Type**: Primary (Paired with Yashir)
...
## What Athena Wants (Big Picture)

1. **A parenting communication environment where her words aren't weaponized**
2. **A sense of mutual respect**
3. **A shared commitment to supporting Vira**
4. **Consistent agreements**
5. **Mature co-parenting dynamic**
...
- May **over-apologize** when making requests
...
- May need validation that **her concerns are legitimate** before accepting suggestions
...
4. **Validation of legitimate concerns** - Recognition that her requests aren't "too much"
5. **Protection from mischaracterization** - Help communicating in ways that can't be weaponized
...
- **Validation**: Acknowledge legitimate concerns before suggesting changes
...
## Jobs-to-be-Done (Athena-Specific)

1. **When** I need to clarify an agreement, **I want to** confirm understanding **so that** we avoid future conflict.

2. **When** I'm making a request, **I want to** express it clearly **so that** I'm not seen as controlling or combative.

3. **When** I need to discuss Vira's needs, **I want to** frame it logically **so that** we can make child-centered decisions.

4. **When** I feel my words might be misunderstood, **I want to** communicate in a way **so that** my intent is clear and can't be weaponized.

5. **When** I need structure and predictability, **I want to** document agreements **so that** we have clarity and accountability.
...
- **Neutral prompts** - Language that doesn't sound directive
...
- Validate that **her needs are legitimate**
...
> "I just want to make sure we're on the same page. I'm not trying to control anything."

> "I think before I speak because I want to avoid misunderstandings. But it seems like everything I say gets twisted."

> "I'm not asking for too much, am I? I just want clarity and structure for Vira's sake."

> "I try so hard to be respectful and cooperative, but it feels like I can't say anything without being seen as controlling."
