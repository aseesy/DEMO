...
1. **Large serif headings** with italicized emphasis ("Moving forward, _together apart._")
...
<div className="text-center">
  ...
  <p className="text-lg text-gray-700 mt-4 mb-8">Expert communication support for co-parents</p>
...
_Professional Design Update - LiaiZen Design System_
_Generated: November 21, 2025_
_Theme: Professional Mediation & Support_
