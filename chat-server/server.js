...
app.use('/api', aiRoutes); // AI routes: /api/tasks/generate, /api/mediate/analyze
app.use('/api', connectionsRoutes); // Connections: /api/invite, /api/join, /api/contact, /api/auth/signup-with-token
// ========================================
