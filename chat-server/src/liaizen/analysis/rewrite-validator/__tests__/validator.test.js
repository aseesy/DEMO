  ...
  describe('validateRewritePerspective', () => {
    ...
    describe('confidence scoring', () => {
      ...
      it('should indicate sender signals detected', () => {
        const result = validator.validateRewritePerspective(
          "I need us to communicate better."
        );
...
describe('Fallback Rewrites', () => {
  describe('detectCategory', () => {
    ...
    it('should detect triangulation', () => {
      ...
      expect(fallbacks.detectCategory("tell the kids their dad doesn't care")).toBe('triangulation');
    });
    ...
    it('should use language analysis when available', () => {
      ...
      expect(fallbacks.detectCategory("some message", analysisWithTriangulation)).toBe('triangulation');
  ...
  describe('getFallbackRewrites', () => {
    ...
    it('should always set isFallback to true', () => {
      const categories = ['you suck', "it's your fault", 'tell your dad', "I'll call my lawyer", 'you should', 'hello'];
  ...
  describe('FALLBACK_REWRITES structure', () => {
    it('should have all required categories', () => {
      const expectedCategories = ['attack', 'blame', 'demand', 'threat', 'triangulation', 'generic'];
