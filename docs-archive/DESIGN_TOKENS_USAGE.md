...
```jsx
<div className="border-2 border-[#C5E8E4] bg-[#E6F7F5]">Card Content</div>
```

**After:**

```jsx
<div className="border-2 border-teal-light bg-teal-lightest">Card Content</div>
```
...
```jsx
<div className="bg-white rounded-xl border-2 border-teal-light shadow-sm p-6">Card Content</div>
```
