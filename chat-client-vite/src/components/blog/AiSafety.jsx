...
export function AiSafety() {
    const meta = {
        ...
        subtitle: "Addressing privacy, security, and the reliability of AI in sensitive family matters. Why LiaiZen puts safety first.",
        date: "Dec 15, 2025",
        readTime: "7 min read"
    };
    ...
    return (
        <BlogArticleLayout meta={meta} breadcrumbs={breadcrumbs} keyTakeaways={keyTakeaways}>
            ...
            <p>
                Handing over your most sensitive, stressful conversations to an algorithm is a big leap of faith. It's reasonable to ask: <em>Is this safe? Who is reading this? Can this be used against me?</em>
            </p>
            <p>
            ...
            <p>
                Your co-parenting messages shouldn't be fodder for ad targeting.
            </p>
            <ul>
                <li><strong>Encryption:</strong> All messages are encrypted in transit and at rest.</li>
                <li><strong>No Ad Sales:</strong> We do not sell your personal conversation data to advertisers. Our business model is subscription-based, meaning <em>you</em> are the customer, not the product.</li>
                <li><strong>Data Ownership:</strong> You own your data. You can export your communication history for legal purposes anytime.</li>
            </ul>

            <h2>2. The "Bias" Myth</h2>
            <p>
                A common worry is that the AI might "side" with one parent.
            </p>
            <p>
                <em>"What if my ex manipulates the AI to make me look bad?"</em>
            </p>
            <p>
                LiaiZen's AI is trained on successful conflict resolution patterns, specifically the BIFF method (Brief, Informative, Friendly, Firm). It does not "know" who is right or wrong in your argument. It only judges the <strong>effectiveness</strong> of the communication.
            </p>
            <p>
                It will correct <em>both</em> parents equally if they use toxic language. It is a mirror, reflecting your words back to you without judgment.
            </p>

            <h2>3. The "Human in the Loop" (That's You)</h2>
            <p>
                LiaiZen is an <strong>assistant</strong>, not an agent. It never sends a message on your behalf automatically.
            </p>
            <p>
            ...
            <p>
                LiaiZen actually <strong>reduces</strong> this risk by imposing structure. Features like "Calm Mode" (which delays delivery of non-urgent messages) prevent devices from being used as tools of harassment.
            </p>
