...
export function WhatKidsNeed() {
    const meta = {
        title: <>What Children Need Most <span className="text-teal-600">During High-Conflict Co-Parenting</span></>,
        ...
        <BlogArticleLayout meta={meta} breadcrumbs={breadcrumbs} keyTakeaways={keyTakeaways}>
            ...
            <div className="bg-white border-l-4 border-teal-500 shadow-sm p-6 my-8 rounded-r-lg">
                <p className="font-medium text-gray-900 m-0 italic">
                    "Children don't need their parents to be partners. They need to not be soldiers in their parents' war."
                </p>
            </div>
            ...
            <p>
                <strong>What children need:</strong> Explicit permission to love both parents freely. "I'm glad you had fun with Dad this weekend" costs nothing and means everything.
            </p>

            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 my-8">
                <h4 className="text-lg font-bold text-gray-900 mb-4">Phrases That Free Children from Loyalty Conflicts</h4>
                <div className="space-y-3">
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                        <p className="text-gray-900">"It's good that you love your mom/dad. I want you to."</p>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                        <p className="text-gray-900">"Tell me about your weekend" (without interrogation or commentary)</p>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                        <p className="text-gray-900">"Whatever happens between me and your mom/dad, we both love you."</p>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                        <p className="text-gray-900">"You don't have to choose sides. You're allowed to love both of us."</p>
                    </div>
                </div>
            </div>
            ...
            <p>
                <strong>What children need:</strong> To be completely shielded from the conflict between their parents. This means:
            </p>
            <ul>
            ...
            <p>
                Research consistently shows that children's outcomes improve dramatically when they have at least one <a href="/co-parenting-communication/emotional-regulation" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">emotionally regulated</a> parent. This person provides:
            </p>
            <ul>
            ...
            <p>
                <strong>What children need:</strong> You don't need to be perfect. You need to be the steadier presence—the one who doesn't spiral, who doesn't vent to them, who stays regulated even when the other parent doesn't.
            </p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-6 my-8">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-white rounded-lg p-4 border border-red-100">
                        ...
                        <p className="text-gray-600 text-sm">"Tell your dad he needs to pay me back for the school trip."</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-red-100">
                        <p className="font-medium text-gray-900 mb-2">The Spy</p>
                        <p className="text-gray-600 text-sm">"What did Mom say about me?" "Who was at Dad's house?"</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-red-100">
                        <p className="font-medium text-gray-900 mb-2">The Confidant</p>
                        <p className="text-gray-600 text-sm">"Your father is so difficult. You're the only one who understands."</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-red-100">
                        <p className="font-medium text-gray-900 mb-2">The Caretaker</p>
                        <p className="text-gray-600 text-sm">"Are you okay, Mom?" (worrying about parent's emotional state)</p>
                    </div>
                </div>
            </div>
            ...
            <p>
                It's tempting to want children to know "the truth" about the other parent, especially when you feel wronged. But children don't benefit from adult information. They benefit from being allowed to form their own relationships with each parent.
            </p>
            <p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 my-8">
                ...
                <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-3">
                        ...
                        <span>Have I said anything negative about their other parent in front of them recently?</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-gray-400">○</span>
                        <span>Do I ask questions about the other household that are really about my conflict, not their wellbeing?</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-gray-400">○</span>
                ...
                <p className="text-gray-600 mt-4">If you answered yes to any of these, you have an immediate opportunity to protect your children better. Not by being perfect—by being more intentional.</p>
            </div>
            ...
            <p>
                <a href="/liaizen/how-ai-mediation-works" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">LiaiZen</a> is designed to reduce the burden of co-parent conflict so you have more energy for what matters: your children.
            </p>
            <ul>
                <li><strong>Less escalation</strong> – Lower-conflict communication means less stress that children sense</li>
                <li><strong>Faster resolution</strong> – Disputes resolved quickly mean less time in conflict mode</li>
                <li><strong>Better documentation</strong> – Clear records mean fewer disputes about what was agreed</li>
                <li><strong><a href="/co-parenting-communication/emotional-regulation" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">Supported regulation</a></strong> – You stay calmer, which means your children feel calmer</li>
            </ul>
            <p>
            ...
            <div className="mt-16 pt-12 border-t border-gray-100">
                ...
                <div className="grid gap-6">
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">My co-parent doesn't shield the kids from conflict. What can I do?</h4>
                        <p className="text-gray-600 leading-relaxed">Focus on your household. One home that's a conflict-free zone is better than none. Be the stable, regulated parent your children need. You can also address specific behaviors through co-parenting coordination or mediation, but ultimately you can't control what happens in the other home—only in yours.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">My child asks questions about why we're not together. What do I say?</h4>
                        <p className="text-gray-600 leading-relaxed">Age-appropriate honesty without blame works best: "Mom and Dad work better living in different houses, but we both love you." Avoid details, avoid blame, and reassure them it's not their fault and they don't have to choose sides.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">My child seems to prefer the other parent. Is that my fault?</h4>
                        <p className="text-gray-600 leading-relaxed">Children's preferences fluctuate for many reasons—it doesn't necessarily reflect your parenting. Focus on being present and consistent in your time with them. Avoid competing for their affection; it puts them in an impossible position. If you're concerned about alienation, consult a family therapist.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">How do I handle it when my child repeats negative things about me that they heard at the other house?</h4>
                        <p className="text-gray-600 leading-relaxed">Stay calm. Don't defend yourself extensively or attack the other parent in response. A simple "I hear you, and I understand that's what you heard. What do you think?" can open dialogue without fueling conflict. If it's persistent, address it privately with your co-parent or through a mediator.</p>
                    </div>
                </div>
            </div>
        </BlogArticleLayout>
