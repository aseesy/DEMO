...
export function EmotionalRegulation() {
    const meta = {
        title: <>How Emotional Regulation Changes <span className="text-teal-600">Co-Parenting Outcomes</span></>,
    ...
    return (
        <BlogArticleLayout meta={meta} breadcrumbs={breadcrumbs} keyTakeaways={keyTakeaways}>
            ...
            <ul>
                <li><strong>Noticing</strong> your emotional state as it arises</li>
                <li><strong>Allowing</strong> the feeling without being controlled by it</li>
                <li><strong>Choosing</strong> your response based on your goals, not your impulses</li>
                <li><strong>Recovering</strong> more quickly after stress activation</li>
            </ul>
            <p>
            ...
            <p>
                Co-parenting communication is uniquely triggering for several reasons:
            </p>
            <ul>
                <li><strong>High stakes</strong> – Your children's wellbeing is on the line</li>
                <li><strong>Shared history</strong> – <a href="/co-parenting-communication/emotional-triggers" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">Past wounds</a> get activated by present messages</li>
                <li><strong>Limited control</strong> – You can't make them behave differently</li>
                <li><strong>Ongoing contact</strong> – Unlike other difficult relationships, you can't walk away</li>
                <li><strong>Identity involvement</strong> – Attacks on your parenting feel like attacks on your worth</li>
            </ul>
            <p>
            ...
            <p>
                When emotional regulation fails, a predictable cascade unfolds:
            </p>
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">A message arrives that activates your threat response</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Heart rate increases, cortisol floods, thinking narrows</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center font-bold text-sm flex-shrink-0">3</div>
                        <div>
                            <p className="font-medium text-gray-900 mb-1">Impulsive Response</p>
                            <p className="text-gray-600 text-sm">You send a message designed to defend, attack, or prove a point</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Your co-parent reacts to your reaction, and the conflict spirals</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-8 h-8 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center font-bold text-sm flex-shrink-0">5</div>
                        <div>
                            <p className="font-medium text-gray-900 mb-1">Regret</p>
                            <p className="text-gray-600 text-sm">Hours later, you wish you'd handled it differently</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <p>
                In that gap, everything changes:
            </p>
            <ul className="marker:text-teal-500">
                <li><strong>Perception expands</strong> – You can see their message more objectively</li>
                <li><strong>Options appear</strong> – You recognize you have choices beyond fight or flight</li>
                <li><strong>Long-term thinking returns</strong> – You remember what actually matters</li>
                <li><strong>Strategic response becomes possible</strong> – You can choose words that serve your goals</li>
            </ul>
            <p>
                This is the difference between <a href="/co-parenting-communication/reaction-vs-response" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">reaction and response</a>. One is automatic; the other is chosen.
            </p>
            ...
            <p>
                Before responding to any charged message, take 30 seconds to notice your body:
            </p>
            <ul>
            ...
            <p>
                If you're above a 6, your response will likely be reactive. <a href="/co-parenting-communication/pause-before-reacting" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">Wait until you're calmer</a>.
            </p>

            <h3>3. The "What Do I Actually Need?" Question</h3>
            <p>
                Before typing a response, ask yourself: "What outcome do I actually need here?"
            </p>
            <p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 my-8">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-100 mb-4">
                    <p className="text-gray-900">"You forgot to send the permission slip AGAIN. This is exactly why I can't trust you with anything important."</p>
                </div>

                <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-red-50 rounded-lg p-4 border border-red-100">
                        <p className="text-sm font-medium text-red-700 mb-2">Dysregulated Response:</p>
                        <p className="text-gray-900 text-sm">"Oh really? You want to talk about trust? You're the one who showed up 45 minutes late last week. At least I actually remember things that matter."</p>
                    </div>
                    <div className="bg-teal-50 rounded-lg p-4 border border-teal-100">
                        <p className="text-sm font-medium text-teal-700 mb-2">Regulated Response:</p>
                        <p className="text-gray-900 text-sm">"You're right, I missed it. I've sent it now. I'll set a reminder system for future forms."</p>
                    </div>
                </div>
            </div>
            ...
            <p>
                <a href="/liaizen/how-ai-mediation-works" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">LiaiZen's AI-guided mediation</a> acts as an external regulatory system:
            </p>
            <ul>
                <li><strong>Creates forced pauses</strong> – Interrupts the trigger-to-response speed</li>
                <li><strong>Offers calmer alternatives</strong> – Shows you what a regulated response could sound like</li>
                <li><strong>Highlights escalation patterns</strong> – Helps you notice when you're reactive</li>
                <li><strong>Preserves your intent</strong> – Keeps your underlying concerns while improving delivery</li>
            </ul>
            <p>
            ...
            <p>
                Every regulated response you send is a deposit in multiple accounts:
            </p>
            <ul>
                <li><strong>Your mental health</strong> – Less time spent in cortisol-flooded states</li>
                <li><strong>Your relationship with your children</strong> – They sense your stability</li>
                <li><strong>Your legal standing</strong> – <a href="/court-safe-co-parenting-messages" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">Calm messages look better in court</a></li>
                <li><strong>Your co-parenting dynamic</strong> – Even difficult dynamics can slowly shift</li>
                <li><strong>Your children's future</strong> – <a href="/child-centered-co-parenting" className="text-teal-600 hover:text-teal-800 underline decoration-teal-300 underline-offset-2 font-medium">They're learning from watching you</a></li>
            </ul>
            <p>
            ...
            <div className="mt-16 pt-12 border-t border-gray-100">
                ...
                <div className="grid gap-6">
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">Isn't emotional regulation just bottling things up?</h4>
                        <p className="text-gray-600 leading-relaxed">Not at all. Suppression means pretending you don't feel anything. Regulation means feeling fully while choosing how to express it. You still process the emotion—you just don't let it write your messages for you.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">What if I regulate but my co-parent never does?</h4>
                        <p className="text-gray-600 leading-relaxed">Your regulation still changes the dynamic. Conflict needs two escalators. When you stop escalating, conflicts resolve faster and your stress levels drop—regardless of what they do. You can't control them, but you can stop being controlled by their behavior.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">How long does it take to get better at this?</h4>
                        <p className="text-gray-600 leading-relaxed">You'll notice small improvements within weeks of consistent practice. Major shifts typically take 3-6 months. Tools like <a href="/liaizen/how-ai-mediation-works" className="text-teal-600 hover:text-teal-700 underline decoration-teal-200 underline-offset-2">AI-guided mediation</a> can accelerate the process by providing support in real-time while you build the skill.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-200 border border-transparent hover:border-gray-200">
                        <h4 className="text-lg font-bold text-gray-900 mb-2">Does staying regulated mean I can't set boundaries?</h4>
                        <p className="text-gray-600 leading-relaxed">The opposite. Regulated communication makes boundaries clearer and more effective. "I won't be responding to messages that include personal attacks" lands better when delivered calmly than when fired off in anger. Regulation makes your boundaries more powerful, not weaker.</p>
                    </div>
                </div>
            </div>
        </BlogArticleLayout>
