                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {category.articles.map((article) => (
                        ...
                        >
                            ...
                            <div className={`bg-teal-100 ${article.featured ? 'md:w-1/2 min-h-[300px]' : 'h-48'} flex items-center justify-center relative`}>
                                ...
                                {article.comingSoon && (
                                    <div className="absolute inset-0 bg-white/60 flex items-center justify-center">
                                        <span className="bg-white px-3 py-1 rounded-full text-sm font-medium text-gray-500 shadow-sm border border-gray-200">Coming Soon</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className={`p-6 sm:p-8 ${article.featured ? 'md:w-1/2 flex flex-col justify-center' : ''}`}>
                                ...
                                <h3 className={`font-bold text-teal-dark mb-3 ${!article.comingSoon ? 'group-hover:text-teal-medium transition-colors' : ''} ${article.featured ? 'text-2xl sm:text-3xl' : 'text-xl'}`}>
                                    {article.title}
                                </h3>
            ...
            <footer className="bg-gray-50 border-t border-gray-200 py-12 px-4">
                <div className="max-w-7xl mx-auto flex flex-col items-center">
                    ...
                    <div className="flex gap-6 mb-6">
                        ...
                        <a href="/liaizen-ai-co-parenting" className="text-gray-500 hover:text-teal-medium">LiaiZen AI</a>
