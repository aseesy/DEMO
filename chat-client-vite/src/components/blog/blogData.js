    ...
    pillars: [
        {
            ...
            description: 'Practical guides, scripts, and strategies to help you communicate effectively with your co-parent, even in high-stress situations.',
            articles: [
                {
        ...
        },
        {
            ...
            description: 'Navigating complex dynamics, setting boundaries, and protecting your peace when emotions run high.',
            articles: [
                {
        ...
        },
        {
            ...
            description: 'Keeping children the focus, modeling healthy communication, and shielding them from conflict.',
            articles: [
                {
            ...
            articles: [
                {
                    ...
                    excerpt: "Demystifying the technology that helps you rewrite toxic messages in real-time.",
                ...
                },
                {
                    ...
                    excerpt: "When the red mist descends, you need a safety net. Here's why AI is better than willpower.",
