...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Resources Section (Blog Categories) */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              { title: 'Legal-Friendly Co-Parenting', path: '/court-safe-co-parenting-messages/' },
            ].map((item) => (
              <a
                key={item.path}
                href={item.path}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <svg className="w-5 h-5 text-teal-medium opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
