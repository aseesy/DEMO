...
export function Navigation({ currentView, setCurrentView, onLogout }) {
  const navItems = [
    { 
      id: 'dashboard', 
      label: 'Dashboard', 
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => setCurrentView(item.id)}
                className={`relative flex flex-col items-center justify-center gap-1.5 min-w-[60px] px-2 py-2 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4DA8B0] focus:ring-offset-2 ${
                  isActive
