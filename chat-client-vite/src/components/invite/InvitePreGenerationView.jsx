...
import { AddUserIcon, EmailIcon, LinkIcon, CodeIcon, CheckIcon, CheckCircleIcon, SpinnerIcon } from './InviteIcons.jsx';
...
export function InvitePreGenerationView({
  ...
  return (
    <>
      ...
      {/* Email Input */}
      {inviteMethod === 'email' && (
        <EmailInput value={inviteeEmail} onChange={onEmailChange} />
      )}
