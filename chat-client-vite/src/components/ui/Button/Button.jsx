...
const variants = {
  ...
  'teal-solid':
    'bg-teal-medium text-white hover:bg-teal-dark disabled:bg-gray-400 shadow-md hover:shadow-lg',
  'teal-outline':
    'border-2 border-gray-900 text-gray-900 bg-transparent hover:bg-gray-50 disabled:border-gray-400 disabled:text-gray-400',
};
...
export const Button = ({
  ...
  const baseClasses =
    'font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4DA8B0] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] flex items-center justify-center gap-2';
