...
export function InviteTaskModal({ isOpen, onClose, onSuccess }) {
  ...
  return (
    ...
    >
      {/* Tab Selector */}
      <div className="flex border-b border-gray-200 mb-4 -mx-4 sm:-mx-6 px-4 sm:px-6">
        <button
          onClick={() => { setActiveTab('send'); setLocalError(''); }}
        ...
        <button
          onClick={() => { setActiveTab('receive'); setLocalError(''); setValidationResult(null); }}
          className={`px-4 py-2.5 font-medium text-sm transition-colors ${
            activeTab === 'receive'
              ? 'border-b-2 border-teal-500 text-teal-700'
              : 'text-gray-500 hover:text-gray-700'
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-center">
                ...
                <div className="flex items-center justify-center gap-2">
                  <span className="font-mono font-bold text-2xl text-teal-700">{generatedResult.code}</span>
                  <button
      ...
      {activeTab === 'receive' && (
        <div className="space-y-4">
          <div>
            <label htmlFor="pairing-code" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Format: LZ-XXXXXX (6 characters after LZ-)</p>
          </div>
