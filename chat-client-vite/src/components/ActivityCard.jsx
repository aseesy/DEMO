    ...
    <div className="bg-white rounded-lg border-2 border-teal-light p-3 sm:p-4 hover:border-teal-medium transition-all">
      ...
      {(activity.days_of_week && activity.days_of_week.length > 0) || (activity.start_time && activity.end_time) ? (
        <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 mb-2">
          <svg className="w-4 h-4 text-teal-medium flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {activity.split_type && activity.split_type !== 'equal' && (
        <div className="mt-2 pt-2 border-t border-gray-100">
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <svg className="w-3.5 h-3.5 text-teal-medium" fill="none" stroke="currentColor" viewBox="0 0 24 24">
