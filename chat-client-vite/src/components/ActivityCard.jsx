...
export function ActivityCard({ activity, onEdit, onDelete }) {
  ...
  return (
    <div className="bg-white rounded-lg border-2 border-[#C5E8E4] p-3 sm:p-4 hover:border-[#4DA8B0] transition-all">
      ...
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          <button
            ...
            className="p-1.5 hover:bg-[#E6F7F5] rounded transition-colors touch-manipulation"
      ...
      {/* Schedule Details */}
      {(activity.days_of_week && activity.days_of_week.length > 0) || (activity.start_time && activity.end_time) ? (
        <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 mb-2">
          <svg className="w-4 h-4 text-[#4DA8B0] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {activity.split_type && activity.split_type !== 'equal' && (
        <div className="mt-2 pt-2 border-t border-gray-100">
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <svg className="w-3.5 h-3.5 text-[#4DA8B0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
