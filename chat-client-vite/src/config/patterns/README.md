...
- `simple-responses.js` - Simple response strings that don't need analysis
...
These patterns should match the backend patterns in `chat-server/src/config/patterns/`.
...
3. Update backend patterns to match
