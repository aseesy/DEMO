...
const quizzes = [
  {
    ...
    description:
      'Discover your natural approach to co-parenting through 10 real-world scenarios. Are you child-centered, collaborative, boundary-focused, or guarded?',
...
export function QuizzesPage() {
  return (
    <div className="min-h-dvh bg-gradient-to-b from-white to-teal-50 pb-nav-mobile pt-nav-mobile overflow-y-auto">
      {/* Header */}
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Gain insights into your co-parenting style and discover ways to improve communication
            with your co-parent.
          </p>
        </div>
