      ...
      <div className="max-w-md w-full text-center">
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm">
          ...
          <p className="text-gray-600 mb-6">
            This invitation link is missing required information. Please check your message for the
            correct link.
          </p>
          <Button onClick={onNavigateSignIn} fullWidth>
            Go to Sign In
          </Button>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm">
          {successMessage ? (
            ...
            <>
              ...
              <Button onClick={onNavigateHome} fullWidth>
                Go to Dashboard
              </Button>
            </>
          ) : (
      ...
      <div className="max-w-md w-full text-center">
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 shadow-sm">
          ...
          <h1 className="font-serif text-2xl font-bold text-teal-dark mb-2 flex items-center gap-2">
            Welcome to{' '}
            <img src="/assets/wordmark.svg" alt="LiaiZen" className="h-7 w-auto inline-block" />!
          </h1>
          <p className="text-gray-600">{successMessage}</p>
          <div className="mt-4">
            <div className="inline-block animate-spin rounded-full h-6 w-6 border-2 border-teal-lightest border-t-teal-medium" />
  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-200 p-6 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <Button onClick={onReject} variant="tertiary" fullWidth size="medium">
          No, wrong person
        </Button>
      </div>
    ...
    <>
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <Input
          ...
          data-form-type="other"
          error={
            confirmPassword && formPassword !== confirmPassword ? 'Passwords do not match' : ''
          }
        />
