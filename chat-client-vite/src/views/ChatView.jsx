...
import { trackMessageSent, trackMessageFlagged, trackAIIntervention } from '../utils/analytics.js';
...
export function ChatView({
  ...
  if (!inviteState) {
    console.error('ChatView: inviteState is undefined. Make sure to use ChatViewLegacy wrapper or pass inviteState prop.');
    return null;
  }
  ...
  if (!inviteHandlers) {
    console.error('ChatView: inviteHandlers is undefined. Make sure to use ChatViewLegacy wrapper or pass inviteHandlers prop.');
    return null;
  }
