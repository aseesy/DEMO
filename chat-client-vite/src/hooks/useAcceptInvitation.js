 ...
 */
export function validateSignupForm({ displayName, formEmail, formPassword, confirmPassword, agreeToTerms }) {
  if (!displayName?.trim()) {
...
export function useAcceptInvitation() {
  ...
  }, [displayName, formEmail, formPassword, confirmPassword, agreeToTerms, token, shortCode, setEmail, setPassword, setUsername, validateFromContext, clearInvitationState, navigate]);
