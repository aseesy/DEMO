...
export function useInviteCoParent() {
  ...
  }, [inviteMethod, inviteeEmail, clearError, createPairing, buildInviteUrl, buildShareableMessage, username, navigate]);
   ...
   */
  const handleMethodChange = React.useCallback((method) => {
